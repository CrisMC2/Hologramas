...
class Login_Controller:
    ...
    def action_button(self, button_id):
            if button_id == 1:
                    ...
                    self.textEdit_2.textChanged.connect(lambda: self.updateTextEditStyle(self, self.textEdit_2))
                    self.textEdit_10.textChanged.connect(lambda: self.updateTextEditStyle(self, self.textEdit_10))
                    self.textEdit_13.textChanged.connect(lambda: self.updateTextEditStyle(self, self.textEdit_13))
                    self.textEdit_2.textChanged.connect(lambda: self.validateTextInput_2(self, self.textEdit_2, 42))
                    self.textEdit_10.textChanged.connect(lambda: self.validateTextInput_2(self, self.textEdit_10, 42))
                    self.textEdit_13.textChanged.connect(lambda: self.validateTextInput_2(self, self.textEdit_13, 42))
                    self.textEdit_2.textChanged.connect(lambda: self.mask_password(self, self.textEdit_2, 'real_text'))
                    self.textEdit_10.textChanged.connect(lambda: self.mask_password(self, self.textEdit_10, 'real_text_3'))
                    self.textEdit_13.textChanged.connect(lambda: self.mask_password(self, self.textEdit_13, 'real_text_4'))
