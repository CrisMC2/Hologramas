...
# Inicializar modelo, landmark, helper y etiquetas
modelo, landmark, help_predictor, labels = inicializar_componentes()

from vtk.config.gesture_settings import (
    GESTO_DISPLACE_LEFT,
...
class GestureInteractorStyle(vtk.vtkInteractorStyleTrackballCamera):
    ...
    def interpolar_frames(self, frames, n_objetivo=60):
    ...
    def on_timer(self, obj, event):
        ...
        self.landmarks = landmark.guardar_frames(frame, 30)

        if self.landmarks and len(self.landmarks) == 30:
